...
const allCourses: Course[] = [
  ...
  },
  {
    ...
    durationText: "Self-paced",
    tagline: "Paint beautiful floral watercolor nail art.",
    description: "Discover the beauty of floral watercolor nail art with our comprehensive workshop. Learn to create stunning flower designs that will add elegance and charm to your nail art repertoire. Let your creativity bloom with BLOM.",
    notes: [
