...
export const lessons: Lesson[] = [
  ...
  { id: "xmas-l3-10", moduleId: "xmas-m3", title: "Design 4 - Part 1", durationSec: 300, poster: "https://picsum.photos/seed/xmas-d4-1/400/225", videoUrl: "https://iframe.mediadelivery.net/embed/495863/7d2919e5-3c3c-4223-9c61-816c709395a2?autoplay=true&loop=false&muted=false&preload=true&responsive=true", resources: [], order: 10 },
  ...
  { id: "xmas-l3-11c", moduleId: "xmas-m3", title: "Sealing your designs and sugaring", durationSec: 300, poster: "https://picsum.photos/seed/xmas-sealing-sugaring/400/225", content: `<h3>Sealing your designs and sugaring</h3><p>Learn the proper techniques for sealing your watercolor nail art designs and adding the perfect sugaring effect for a professional finish.</p><p>This step is crucial for ensuring your beautiful watercolor designs last and maintain their vibrant appearance.</p>`, resources: [], order: 11.7 },
