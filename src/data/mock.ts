...
const allCourses: Course[] = [
  ...
  },
  {
    ...
    summary: "Create festive Christmas watercolor nail art designs. Learn beautiful holiday-themed patterns perfect for the festive season.",
    level: "Beginner",
    tags: ["Watercolor", "Nail Art", "Christmas", "Holiday"],
    durationText: "Self-paced",
    tagline: "Create beautiful Christmas watercolor nail art.",
    description: "Get into the festive spirit with our Christmas Watercolor Workshop! Learn to create stunning holiday-themed nail art designs that will add sparkle and joy to your client's nails this Christmas season.",
    notes: [
